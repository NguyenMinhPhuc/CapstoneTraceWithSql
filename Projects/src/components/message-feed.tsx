    ...
    return (
      <div className="flex flex-col items-center justify-center h-full text-center p-8">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Chọn một hội thoại từ bên trái để xem tin nhắn hoặc bắt đầu một hội
          thoại mới.
        </p>
      </div>
    );
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const messageData = {
        ...
        senderName:
          currentUserData.displayName || currentUserData.email || "N/A",
        content: newMessage,
        createdAt: new Date(),
      };
      ...
      batch.update(conversationDocRef, {
        ...
        lastMessageSnippet:
          newMessage && typeof newMessage === "string"
            ? newMessage.substring(0, 90)
            : "",
              ...
              >
                {!isCurrentUser && (
                  <Avatar className="h-8 w-8">
                    <AvatarFallback>
                      {msg.senderName && typeof msg.senderName === "string"
