...
const formSchema = z.object({
  recipients: z
    .array(z.string())
    .min(1, "Vui lòng chọn ít nhất một người nhận."),
...
export function NewConversationForm({
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    const conversationData = {
      ...
      lastMessageSnippet:
        values.message && typeof values.message === "string"
          ? values.message.substring(0, 90)
          : "",
    ...
    try {
      ...
      toast({
        variant: "destructive",
        title: "Lỗi",
        description: "Không thể tạo hội thoại.",
      });
    }
  }
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input
                  placeholder="Ví dụ: Thắc mắc về cách nộp báo cáo"
                  {...field}
                />
              </FormControl>
              <FormMessage />
