...
export function ViewEarlyInternshipProgressDialog({
  ...
  const handleSubmit = async () => {
    ...
    try {
      await progressService.createEarlyInternshipReport(newReportData);
  ...
  const handleAction = async (
    ...
    try {
      await progressService.updateEarlyInternshipReport(reportId, {
        status,
        supervisorComments: editingComment,
        hours: status === "approved" ? Number(editingHours) : 0,
      ...
      console.error("Error updating early internship report via API:", error);
      toast({
        variant: "destructive",
        title: "Lỗi",
